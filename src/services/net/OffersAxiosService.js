...
export const OffersAxiosService = {
     ...
     */
    getPromotionalBanners: (limit = 5, is_active = true) => {
     ...
     */
    getSimilarOffers: (offerId, limit = 4) => {
