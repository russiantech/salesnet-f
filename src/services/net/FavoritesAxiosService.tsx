...
export const FavoritesAxiosService = {
    ...
    updateFavoriteList: (listId: string, data: {
        ...
        return AxiosService.json.put(`/favorites/lists/${listId}`, data);
    },
     ...
     * @returns Promise with operation result
     */
    removeFavoriteItem: (listId: string, itemId: string) => {
     ...
     */
    removeBatchFavoriteItems: async (listId: string, productIds: string[]) => {
     ...
     * @returns Promise with operation result
     */
    moveFavoriteItems: (sourceListId: string, targetListId: string, itemIds: string[]) => {
        console.log(
            `Passed datas: source_list_id: ${sourceListId},
    ...
    toggleFavorite: (productId: string) => {
        return AxiosService.json.post(
            '/favorites/items/toggle',
