...
export const ProductAxiosService = {
   ...
   */
    ...
    getProductsByCategorySlug: async (slug, page, pageSize) => {
    ...
    bySlug: (slug, page, pageSize) => AxiosService.json.get(`/products/${slug}/category`, {
        params: {
            page,
            page_size: pageSize,
        },
    }),
    createProduct: (data) => AxiosService.multipart.post('/products', data),
    updateProduct: (id, data) => AxiosService.multipart.put(`/products/${id}`, data),
    // For JSON data
    updateProductMetadata: (id, data) => AxiosService.json.put(`/products/${id}/metadata`, data),
    // Delete a product
    deleteProduct: (slug) => AxiosService.json.delete(`/products/${slug}`),
    // Create a comment for a product
    createComment: (slug, payload) => AxiosService.multipart.post(`/products/${slug}/comments`, { comment: { body: payload } }),
    // Delete a comment for a product
    deleteComment: (slug, commentId) => AxiosService.json.delete(`/products/${slug}/comments/${commentId}`),
