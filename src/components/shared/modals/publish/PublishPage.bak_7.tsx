...
const PublishPage = ({ productSlug, editProductData }: PublishPageProps) => {
                ...
                <li key={category.id} className="mb-1">
                  <div className="d-flex align-items-center">
                    {hasChildren && (
                      ...
                      >
                        <i className={`bi ${
                          expandedIds.has(category.id) ? 'bi-chevron-down' : 'bi-chevron-right'
                        }`} />
                      </button>
                    )}
    ...
    const CategorySelector1 = ({
        ...
        return (
            <div className={`category-selector ${error ? 'is-invalid' : ''}`} style={{ position: 'relative' }}>
                ...
                {isExpanded && (
                    <div className="category-selector-popover position-absolute w-100 mt-1 shadow" style={{zIndex: 1000}}>
...
const CategorySelector2 = ({
    ...
    return (
        <div className={`category-selector ${error ? 'is-invalid' : ''}`} style={{ position: 'relative' }}>
            ...
            {isExpanded && (
                <div className="category-selector-popover position-absolute mt-1 shadow">
                    <div className="p-2 border rounded bg-white">
                        <input
                            type="text"
                            className="form-control form-control-lg mb-2"
