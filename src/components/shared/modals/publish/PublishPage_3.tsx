...
//       setPublishedProductId(productId || productSlug || null);
//       setShowPostPublishModal(true);
//     } catch (error) {
//       console.error('Publishing error:', error);
//       NotificationService.showDialog(
//         (error as any)?.response?.data?.message || 'Failed to publish product after subscription', 
//         'error'
//       );
//     }
//   };

//   // Handle free publishing without subscription
...
//         await ProductAxiosService.updateProductStatus(id, 'published');
//       }
...
//       console.error('Publishing error:', error);
//       NotificationService.showDialog(
//         error?.response?.data?.error || 'Failed to publish product', 
//         'error'
//       );
//     }
//   };
                ...
                <div className="d-grid gap-3">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      navigator.clipboard.writeText(`${window.location.origin}/products/${publishedProductId}`);
