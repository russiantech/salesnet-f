...
const PublishPage = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (name in formData.deliveryOptions)
            formSection = 'deliveryOptions';
        // Update form data
        setFormData(prev => ({
            ...prev,
            [formSection]: {
