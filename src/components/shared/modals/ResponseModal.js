...
const ResponseModal = ({ show, message, type }) => {
    ...
    return (_jsx(_Fragment, { children: show && (_jsxs("div", { className: `${getClassNames()} mb-2 w-100 fade show`, role: "alert", "aria-live": "assertive", "aria-atomic": "true", children: [_jsxs("div", { className: "toast-header", children: [_jsx("i", { className: `ci-bell text-${type} fs-base me-2` }), _jsx("span", { className: `fw-semibold text-${type}`, children: "Response:" }), _jsx("button", { type: "button", className: "btn-close ms-auto", "data-bs-dismiss": "toast", "aria-label": "Close" })] }), _jsx("div", { className: `toast-body me-2 text-${type}`, children: message })] })) }));
};
export default ResponseModal;
