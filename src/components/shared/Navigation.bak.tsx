                            ...
                            <div className="row">
                                ...
                                < div className="col-lg-9 d-lg-flex pt-3 pt-lg-0 ps-lg-0" >
                                    <ul className="navbar-nav position-relative">
                                        ...
                                        <li className="nav-item me-lg-n2 me-xl-0 rounded-pill badge ">
                                    ...
                                    <ul className="navbar-nav ms-auto d-flex">
                                        ...
                                        <li className="nav-item ">
                                            <NavLink to="!#" data-bs-toggle="modal" data-bs-target="#PublishPage"
                                                className="btn btn-icon btn-lg text-bg-success1 position-relative rounded-circle ms-2">
                                                <span className="position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100 rounded-circle animate-scale fs-lg">
                                                    <i className="ci-powerbank animate-target text-white" />
                                                </span>
                                            </NavLink>
                                        ...
                                        <li className="nav-item ">
                                            <NavLink type="button" className="btn btn-icon btn-lg btn-outline-success1 text-white position-relative rounded-circle animate-shake ms-2" data-bs-toggle="offcanvas" data-bs-target="#searchBox" aria-controls="searchBox" aria-label="Toggle search bar">
                                                <span className="position-absolute top-50 start-100 mt-n1 ms-n3 badge text-bg-success border border-3 border-dark rounded-pill"
                                                   >3</span>
                                                <span className="position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100
                                                rounded-circle animate-scale fs-lg">
                                                    <i className="ci-search animate-target fs-2 m-1" />
                                                </span>
                                            </NavLink>
