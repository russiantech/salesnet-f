        ...
        return (
            <div className="container" style={cardStyle}>
                <div className="card-group">
                    <div className="card btn shadow-lg bg-white"
                         onClick={() => this.props.history.push('/profile/addresses')}>
                        <img className="card-img-top mx-auto" src="/images/world.svg" alt="Card image cap"/>
                    ...
                    &nbsp;
                    <div className="card btn shadow-lg bg-white"
                         onClick={() => this.props.history.push('/profile/orders')}>
                        <img className="card-img-top mx-auto" src="/images/package.svg"
                             alt="Map"/>
                        <div className="card-body">
