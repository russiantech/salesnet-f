...
class RecoverPassword extends React.Component {
    ...
    render() {
        return (_jsx("main", { className: "content-wrapper w-100 px-3 ps-lg-5 pe-lg-4 mx-auto", style: { "maxWidth": "1920px" }, children: _jsxs("div", { className: "d-lg-flex", children: [_jsxs("div", { className: "d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5", style: { maxWidth: '416px' }, children: [_jsxs("header", { className: "navbar px-0 pb-4 mt-n2 mt-sm-0 mb-2 mb-md-3 mb-lg-4", children: [_jsxs("a", { className: "navbar-brand pt-0", href: "/", children: [_jsx("span", { className: "d-flex flex-shrink-0 text-primary rtl-flip me-2", children: _jsx("div", { className: "flex-shrink-0 border rounded-circle", style: { width: '32px' }, children: _jsx("div", { className: "ratio ratio-1x1 rounded-circle overflow-hidden", children: _jsx("img", { src: "/assets/img/us/logos/favicon.svg", alt: "Avatar" }) }) }) }), "Salesnet"] }), _jsx("div", { class: "nav", children: _jsxs("a", { class: "nav-link fs-base animate-underline p-0", href: "/auth/signin", children: [_jsx("i", { class: "ci-chevron-left fs-lg ms-n1 me-1" }), _jsx("span", { class: "animate-target", children: "Back to Sign In" })] }) })] }), _jsx("h1", { className: "h2 mt-auto", children: "Forgot password?" }), _jsx("small", { className: "nav fs-sm mb-4 text-warning", children: "Enter any contact detail you used when you joined and we\u2019ll send you instructions to reset your password." }), _jsxs("form", { className: "needs-validation", id: "signin_form", action: "/auth/signin", method: "post", noValidate: true, children: [_jsxs("div", { className: "position-relative mb-4", children: [_jsx("input", { type: "username", name: "username", className: "form-control form-control-lg", placeholder: "Email or Username or Phone", required: true }), _jsx("div", { className: "invalid-tooltip bg-transparent py-0", children: "Enter Your Logins any of email-or-username-or-phone!" })] }), _jsx("div", { className: "d-flex align-items-center justify-content-between mb-4", children: _jsxs("div", { className: "form-check me-2", children: [_jsx("input", { type: "checkbox", className: "form-check-input", id: "remember-30" }), _jsx("label", { htmlFor: "remember-30", className: "form-check-label", children: "Remember for 30 days" })] }) }), _jsx("button", { type: "submit", className: "btn btn-lg bg-dark text-white w-100", children: "Recover Password." })] }), _jsxs("div", { className: "d-flex align-items-center my-4", children: [_jsx("hr", { className: "w-100 m-0" }), _jsx("span", { className: "text-body-emphasis fw-medium text-nowrap mx-4", children: "or continue with" }), _jsx("hr", { className: "w-100 m-0" })] }), _jsxs("div", { className: "d-flex flex-column flex-sm-row gap-3 pb-4 mb-3 mb-lg-4", children: [_jsxs("button", { id: "google-signin-btn", type: "button", className: "btn btn-lg btn-outline-secondary w-100 px-2", children: [_jsx("i", { className: "ci-google ms-1 me-1" }), "Google"] }), _jsxs("button", { type: "button", disabled: true, className: "btn btn-lg btn-outline-secondary w-100 px-2", children: [_jsx("i", { className: "ci-facebook ms-1 me-1" }), "Facebook"] }), _jsxs("button", { type: "button", disabled: true, className: "btn btn-lg btn-outline-secondary w-100 px-2", children: [_jsx("i", { className: "ci-apple ms-1 me-1" }), "Apple"] })] }), _jsx("footer", { className: "mt-auto", children: _jsxs("p", { className: "fs-xs mb-0", children: ["\u00A9 All rights reserved. ", _jsx("span", { className: "animate-underline", children: _jsx(Link, { className: "animate-target text-dark-emphasis text-decoration-none", to: "/", target: "_blank", rel: "noreferrer", children: "Techa - Russian Developers." }) })] }) })] }), _jsx("div", { className: "d-none d-lg-block w-100 py-4 ms-auto", style: { maxWidth: '1034px' }, children: _jsxs("div", { className: "d-flex flex-column justify-content-end h-100 rounded-5 overflow-hidden", children: [_jsx("span", { className: "position-absolute top-0 start-0 w-100 h-100 d-none-dark", style: { background: 'linear-gradient(-90deg, #accbee 0%, #e7f0fd 100%)' } }), _jsx("span", { className: "position-absolute top-0 start-0 w-100 h-100 d-none d-block-dark", style: { background: 'linear-gradient(-90deg, #1b273a 0%, #1f2632 100%)' } }), _jsx("div", { className: "ratio position-relative z-2", style: { '--cz-aspect-ratio': 'calc(1030 / 1032 * 100%)' }, children: _jsx("img", { src: "../assets/img/us/pages/7.jpg", alt: "Girl" }) })] }) })] }) }));
    }
}
