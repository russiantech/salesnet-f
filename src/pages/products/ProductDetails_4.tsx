              ...
              <div className="d-flex flex-column flex-md-row align-items-md-center gap-3 gap-md-4 h3 container mb-4">
                ...
                <div className="d-flex justify-content-between flex-grow-1 gap-4">
                  ...
                  <div className="d-flex gap-2">
                    <button className="btn btn-sm btn-dark rounded-pill animate-pulse text-dafaut" type="button">
                      <i className="ci-shopping-cart animate-target fs-sm ms-n1 me-1" />
                     Add <i className="ci-dollar-sign"></i> {product.price}
                    </button>
                                ...
                                <table className="table">
                                  <tbody>
                                    {product.attributes.map((attr, index) => (
                                      <tr key={index}>
                                        <th className="text-nowrap" style={{ width: '30%' }}>{attr.key}</th>
                                        <td>{attr.value}</td>
                                      </tr>
                                    ))}
                                  </tbody>
