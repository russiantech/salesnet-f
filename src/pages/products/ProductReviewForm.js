...
const ProductReviewForm = ({ productSlug, onReviewSubmitted }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                onReviewSubmitted();
                // // Reset the form
                document.getElementById('reviewFormTag')?.reset();
                // const form = document.getElementById('reviewForm');
                // if (form instanceof HTMLFormElement) {
                //     form.reset();
                //  }
                setTimeout(() => {
                    window.bootstrap.Modal.getInstance(document.getElementById('reviewForm')).hide();
                }, 1500);
            }
            else {
                // Handle array errors
    ...
    return (_jsx("div", { className: "modal fade", id: "reviewForm", "data-bs-backdrop": "static", tabIndex: -1, children: _jsx("div", { className: "modal-dialog modal-dialog-centered modal-dialog-scrollable", children: _jsxs("form", { id: "reviewFormTag", className: "modal-content", onSubmit: handleSubmit, children: [_jsxs("div", { className: "modal-header border-0", children: [_jsx("h5", { className: "modal-title", children: "Leave a review" }), _jsx("button", { type: "button", className: "btn-close", "data-bs-dismiss": "modal", "aria-label": "Close" })] }), _jsxs("div", { className: "modal-body pb-3 pt-0", children: [_jsxs("div", { className: "mb-3", children: [_jsxs("label", { className: "form-label", children: ["Rating ", _jsx("span", { className: "text-danger", children: "*" })] }), _jsxs("select", { className: `form-select ${validationErrors.rating ? 'is-invalid' : ''}`, value: formData.rating, onChange: (e) => setFormData({ ...formData, rating: e.target.value }), required: true, children: [_jsx("option", { value: "", children: "Choose a rating..." }), [5, 4, 3, 2, 1].map((num) => (_jsxs("option", { value: num, children: [num, " Stars"] }, num)))] }), validationErrors.rating && (_jsx("div", { className: "invalid-feedback", children: validationErrors.rating }))] }), _jsxs("div", { className: "mb-3", children: [_jsxs("label", { className: "form-label", children: ["Review ", _jsx("span", { className: "text-danger", children: "*" })] }), _jsx("textarea", { className: `form-control ${validationErrors.comment ? 'is-invalid' : ''}`, rows: 4, value: formData.comment, onChange: (e) => setFormData({ ...formData, comment: e.target.value }), minLength: 50, maxLength: 1000, required: true }), validationErrors.comment && (_jsx("div", { className: "invalid-feedback", children: validationErrors.comment })), _jsx("small", { className: "form-text", children: "Your review must be at least 50 characters" })] }), _jsxs("div", { className: "mb-3", children: [_jsx("label", { className: "form-label", children: "Would you recommend this product?" }), _jsxs("div", { className: "d-flex gap-3", children: [_jsxs("div", { className: "form-check", children: [_jsx("input", { type: "radio", className: "form-check-input", id: "recommend-yes", name: "recommend", value: "true", checked: formData.recommend === 'true', onChange: (e) => setFormData({ ...formData, recommend: e.target.value }) }), _jsx("label", { className: "form-check-label", htmlFor: "recommend-yes", children: "Yes" })] }), _jsxs("div", { className: "form-check", children: [_jsx("input", { type: "radio", className: "form-check-input", id: "recommend-no", name: "recommend", value: "false", checked: formData.recommend === 'false', onChange: (e) => setFormData({ ...formData, recommend: e.target.value }) }), _jsx("label", { className: "form-check-label", htmlFor: "recommend-no", children: "No" })] })] })] }), _jsx(ResponseModal, { show: responseModal.show, message: responseModal.message, success: responseModal.success, onClose: () => setResponseModal(prev => ({ ...prev, show: false })) })] }), _jsxs("div", { className: "modal-footer flex-nowrap gap-3 border-0", children: [_jsx("button", { type: "button", className: "btn btn-secondary w-100", "data-bs-dismiss": "modal", disabled: isSubmitting, children: "Cancel" }), _jsx("button", { type: "submit", className: "btn btn-dark w-100", disabled: isSubmitting, children: isSubmitting ? (_jsx("div", { style: { height: '8px', width: '8px' }, className: "spinner-border spinner-border-sm", role: "status", children: _jsx("span", { className: "visually-hidden", children: "Submitting..." }) })) : ('Submit Review') })] })] }) }) }));
};
export default ProductReviewForm;
