...
//   // Initialize GLightbox with video support
//   useEffect(() => {
...
//   // Get video thumbnail for YouTube/Vimeo (for poster attribute)
...
//     // For direct video files, return a generic video thumbnail
//     return '/assets/img/us/video-placeholder.png';
//   };

//   // Create media preview component that renders actual video or image
...
//                 {/* <span className="badge rounded-pill bg-dark bg-opacity-75 text-white fs-xs px-2 py-1">
//                   <i className="ci-video me-1"></i>
//                   Video
//                 </span> */}
//                 <span className="badge rounded-pill bg-info1 text-white fs-xs px-1">
...
//                 {/* <div className="btn btn-light btn-sm rounded-pill d-flex align-items-center justify-content-center" 
...
//             </>
//           ) : (
//             // YouTube/Vimeo/Other video platforms - show thumbnail with play button
//             <>
//               <img 
...
//               {/* Video platform badge (top right) */}
//               <div className="position-absolute top-0 end-0 m-2">
...
//     return (
//       <div className="d-flex justify-content-center align-items-center">
//         <span className="ms-2">{error || 'Product not found'}</span>
//       </div>
//     );
...
//           setShouldAutoOpenLightbox(false); // Prevent auto-opening again
//         },
