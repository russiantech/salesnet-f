...
//   const VideoPreview = ({ url, index, isThumb = false }: { url: string; index: number; isThumb?: boolean }) => {
...
//                           ) : (
//                             <>
//                               <VideoPreview url={url} index={index} />
//                               <div className="gallery-overlay"></div>
//                               <i className="ci-zoom-in gallery-zoom-icon"></i>
//                             </>
//                           )}
...
//                             </div>
//                           ) : (
//                             <VideoPreview url={url} index={index} isThumb={true} />
//                           )}
//                           <div className="gallery-overlay"></div>
//                           <i className="ci-zoom-in gallery-zoom-icon"></i>
//                         </a>
          ...
          {urlType === 'image' ? (
            ...
            <>
              ...
              <div className="position-absolute top-0 end-0 m-2">
                ...
                <span className="badge rounded-pill bg-info text-white fs-xs px-2 py-1">
                  <i className="ci-video me-1"></i>
                  Video
                </span>
