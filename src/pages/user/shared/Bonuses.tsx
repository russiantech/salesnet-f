    ...
    <div className="modal-dialog modal-dialog-centered">
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title" id="bonusesModalLabel">My bonuses</h5>
            ...
            <div className="col-sm-6 mb-4 mb-sm-0">
              <div className="position-relative bg-warning text-center rounded-4 overflow-hidden">
                <div className="position-relative z-1 py-3 px-4">
                  ...
                  <div className="h2 text-white pb-1 mb-2">100</div>
            ...
            <div className="col-sm-6">
              <ul className="list-unstyled fs-sm m-0">
                <li className="d-flex align-items-center justify-content-between">
                  Available:
                  <span className="text-dark-emphasis fw-semibold ms-2">100</span>
                </li>
                <li className="d-flex align-items-center justify-content-between">
                  Waiting activation:
                  <span className="text-dark-emphasis fw-semibold ms-2">0</span>
                </li>
                <li className="d-flex align-items-center justify-content-between">
                  Total:
                  <span className="text-dark-emphasis fw-semibold ms-2">100</span>
