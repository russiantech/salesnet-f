                ...
                <div className="col-6 col-md-3 col-xl-2 text-center">
                  <div className="position-relative d-inline-block">
                    ...
                    <h3 className="text-dark fs-sm fw-medium pt-1 mt-2 mb-0">
                      <a className="hover-effect-underline stretched-link text-decoration-none" href="/user/help/techa-help-slug">Track your order</a>
                    </h3>
                  </div>
                </div>
                <div className="col-6 col-md-3 col-xl-2 text-center">
                  <div className="position-relative d-inline-block">
                    ...
                    <h3 className="text-dark fs-sm fw-medium pt-1 mt-2 mb-0">
                      <a className="hover-effect-underline stretched-link text-decoration-none" href="/user/help/techa-help-slug">Edit or cancel order</a>
                    </h3>
                  </div>
                </div>
                <div className="col-6 col-md-3 col-xl-2 text-center">
                  <div className="position-relative d-inline-block">
                    ...
                    <h3 className="text-dark fs-sm fw-medium pt-1 mt-2 mb-0">
                      <a className="hover-effect-underline stretched-link text-decoration-none" href="/user/help/techa-help-slug">Returns &amp; refunds</a>
                    </h3>
                  </div>
                </div>
                <div className="col-6 col-md-3 col-xl-2 text-center">
                  <div className="position-relative d-inline-block">
                    ...
                    <h3 className="text-dark fs-sm fw-medium pt-1 mt-2 mb-0">
                      <a className="hover-effect-underline stretched-link text-decoration-none" href="/user/help/techa-help-slug">My bonus account</a>
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className="card h-100 bg-body-tertiary border-0 p-md-2">
                <div className="card-body">
                  ...
                  <ul className="nav flex-column gap-3">
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Can I track my order in real-time?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Is there an option for express delivery?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Will my parcel be charged customs charges?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Do you offer international delivery?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Why does my statement have a recurring charge?</a>
                    </li>
                  </ul>
                </div>
            ...
            <div className="col">
              <div className="card h-100 bg-body-tertiary border-0 p-md-2">
                <div className="card-body">
                  ...
                  <ul className="nav flex-column gap-3">
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">What is your returns policy?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">I paid with Afterpay, how do returns work?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">What happens to my refund if I return 45 days?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">How do I return something to you?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Can I return an exchange instead of a refund?</a>
                    </li>
                  </ul>
                </div>
                <div className="card-footer nav bg-transparent border-0 pt-0">
            ...
            <div className="col">
              <div className="card h-100 bg-body-tertiary border-0 p-md-2">
                <div className="card-body">
                  ...
                  <ul className="nav flex-column gap-3">
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">How do I place an order?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">My payment was declined, what should I do?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">When will I be charged for my order?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">How do I pay using Google Pay?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">How do I use my Gift Voucher to pay for an order?</a>
                    </li>
                  </ul>
                </div>
                <div className="card-footer nav bg-transparent border-0 pt-0">
            ...
            <div className="col">
              <div className="card h-100 bg-body-tertiary border-0 p-md-2">
                <div className="card-body">
                  ...
                  <ul className="nav flex-column gap-3">
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Can I amend my order after I've placed it?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">I've received a faulty item, what should I do?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">I've received an incorrect item, what do I do?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">I've bought a gift voucher, can I cancel or return it?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">What if isn't right on my customs invoice?</a>
                    </li>
                  </ul>
                </div>
                <div className="card-footer nav bg-transparent border-0 pt-0">
            ...
            <div className="col">
              <div className="card h-100 bg-body-tertiary border-0 p-md-2">
                <div className="card-body">
                  ...
                  <ul className="nav flex-column gap-3">
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Where can I find your size guide?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Where can I find your care instructions?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Can you tell me more about Collusion?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">How do I change my Fit Assistant Information?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">What are your adhesive product guidelines?</a>
                    </li>
                  </ul>
                </div>
                <div className="card-footer nav bg-transparent border-0 pt-0">
            ...
            <div className="col">
              <div className="card h-100 bg-body-tertiary border-0 p-md-2">
                <div className="card-body">
                  ...
                  <ul className="nav flex-column gap-3">
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">How do I create an account?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">I'm having trouble signing into my account.</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">I'm having problems using your App.</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">Do I need to create an account to shop with you?</a>
                    </li>
                    <li>
                      <a className="nav-link hover-effect-underline fw-normal p-0" href="/user/help/techa-help-slug">I'd like to delete my account what should I do?</a>
                    </li>
                  </ul>
                </div>
                <div className="card-footer nav bg-transparent border-0 pt-0">
            ...
            <div className="col-auto mx-auto">
              <ul className="nav nav-pills flex-nowrap text-nowrap">
                <li className="nav-item">
                  <a className="nav-link rounded active" aria-current="page" href="#!">Delivery</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link rounded" href="#!">Returns &amp; refunds</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link rounded" href="#!">Payment</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link rounded" href="#!">Order issues</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link rounded" href="#!">Products &amp; stock</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link rounded" href="#!">Account</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            &quot;breakpoints&quot;: {
              ...
              <div className="swiper-wrapper" id="swiper-wrapper-a106775b6d11e156a" aria-live="polite" style={{height: '355px', transform: 'translate3d(0px, 0px, 0px)'}}>
                ...
                <article className="swiper-slide swiper-slide-active" role="group" aria-label="1 / 4" data-swiper-slide-index={0} style={{width: '304.333px', marginRight: '24px'}}>
                  <a className="ratio d-flex hover-effect-scale rounded overflow-hidden" href="/user/help/techa-help-slug" style={{"--cz-aspect-ratio": 'calc(306 / 416 * 100%)'}}>
                  ...
                  <div className="pt-4">
                    ...
                    <h3 className="h5 mb-0">
                      <a className="hover-effect-underline" href="/user/help/techa-help-slug">When should I place an order to ensure Express Delivery?</a>
                    </h3>
                  </div>
                </article>
                {/* Article */}
                <article className="swiper-slide swiper-slide-next" role="group" aria-label="2 / 4" data-swiper-slide-index={1} style={{width: '304.333px', marginRight: '24px'}}>
                  ...
                  <div className="pt-4">
                    ...
                    <h3 className="h5 mb-0">
                      <a className="hover-effect-underline" href="/user/help/techa-help-slug">Why does my statement have a recurring delivery charge?</a>
                    </h3>
                  </div>
                </article>
                {/* Article */}
                <article className="swiper-slide" role="group" aria-label="3 / 4" data-swiper-slide-index={2} style={{width: '304.333px', marginRight: '24px'}}>
                  ...
                  <div className="pt-4">
                    ...
                    <h3 className="h5 mb-0">
                      <a className="hover-effect-underline" href="/user/help/techa-help-slug">How can I find information about your international delivery?</a>
                    </h3>
                  </div>
                </article>
                {/* Article */}
                <article className="swiper-slide" role="group" aria-label="4 / 4" data-swiper-slide-index={3} style={{width: '304.333px', marginRight: '24px'}}>
                  ...
                  <div className="pt-4">
                    ...
                    <h3 className="h5 mb-0">
                      <a className="hover-effect-underline" href="/user/help/techa-help-slug">Will my parcel be charged additional customs charges?</a>
                    </h3>
                  </div>
                </article>
              </div>
