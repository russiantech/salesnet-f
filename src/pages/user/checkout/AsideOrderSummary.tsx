...
//                         <NavLink className="badge text-bg-info rounded-pill animate-target" to="/user/basket"> Edit </NavLink>
//                     </div>
//                 </div>
...
//           <h2 className="h5 mb-0 me-3">Order summary</h2>
//           <div className="nav animate-scale">
//             <NavLink className="badge text-bg-info rounded-pill animate-target" to="/user/basket">
//               Edit
//             </NavLink>
//           </div>
//         </div>
