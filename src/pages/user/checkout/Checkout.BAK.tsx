            ...
            <main className="content-wrapper">
                <div className="container py-5">
                    ...
                    <div className="nav flex-nowrap align-items-center justify-content-between pb-1 mb-3">
                        ...
                        <i className="ci-plus fs-base me-1"></i><span className="animate-target badge text-bg-dark rounded-pill">Change Address</span></Link>
                                            ...
                                            <div className="mb-lg-4" id="shippingMethod" role="list">
                                                ...
                                                <div className="border-bottom">
                                                    <div className="form-check mb-0" role="listitem" data-bs-toggle="collapse" data-bs-target="#courier" aria-expanded="true" aria-controls="courier">
                                                        <label className="form-check-label d-flex align-items-center text-dark-emphasis fw-semibold py-4">
                                                            <input type="radio" className="form-check-input fs-base me-2 me-sm-3" name="payment-method" defaultChecked />
                        ...
                        <i className="ci-plus fs-base me-1"></i><span className="animate-target badge text-bg-dark rounded-pill">
                            Change Address</span></Link>
                                                    ...
                                                    {/* <div className="collapse show" id="courier" data-bs-parent="#shippingMethod">
                                                        <div className="pb-4 ps-3 ms-2 ms-sm-3">
                                                            <p className="fs-sm">Choose a courier delivery time convenient for you:</p>
                                                            <div className="d-flex justify-content-start">
                                                                <button type="button" className="btn btn-icon btn-sm btn-outline-secodary ms-n2" id="courierTimePrev" aria-label="Prev">
                                                                    <i className="ci-chevron-left fs-lg" />
                                                                </button>
                                                                <div className="swiper swiper-load pt-2" data-swiper="{
                          &quot;slidesPerView&quot;: 2,
                          &quot;spaceBetween&quot;: 12,
                          &quot;navigation&quot;: {
                              ...
                              &quot;spaceBetween&quot;: 24
                                                                    ...
                                                                    <div className="swiper-wrapper">
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Monday, 13</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-mon-1" defaultChecked />
                                                                                <label htmlFor="c-mon-1" className="btn btn-outline-secondary w-100 rounded-pill">12:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-mon-2" />
                                                                                <label htmlFor="c-mon-2" className="btn btn-outline-secondary w-100 rounded-pill">17:00 -
                                                                                    20:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Tuesday, 14</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-tue-1" />
                                                                                <label htmlFor="c-tue-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    12:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-tue-2" />
                                                                                <label htmlFor="c-tue-2" className="btn btn-outline-secondary w-100 rounded-pill">14:00 -
                                                                                    19:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Wednesday, 15</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-wed-1" />
                                                                                <label htmlFor="c-wed-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    12:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-wed-2" />
                                                                                <label htmlFor="c-wed-2" className="btn btn-outline-secondary w-100 rounded-pill">14:00 -
                                                                                    19:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Thursday, 16</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-thu-1" />
                                                                                <label htmlFor="c-thu-1" className="btn btn-outline-secondary w-100 rounded-pill">12:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-thu-2" />
                                                                                <label htmlFor="c-thu-2" className="btn btn-outline-secondary w-100 rounded-pill">17:00 -
                                                                                    20:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Friday, 17</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-fri-1" />
                                                                                <label htmlFor="c-fri-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    12:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-fri-2" />
                                                                                <label htmlFor="c-fri-2" className="btn btn-outline-secondary w-100 rounded-pill">14:00 -
                                                                                    19:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Saturday, 18</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-sat-1" />
                                                                                <label htmlFor="c-sat-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    11:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-sat-2" />
                                                                                <label htmlFor="c-sat-2" className="btn btn-outline-secondary w-100 rounded-pill">13:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Sunday, 19</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-sun-1" />
                                                                                <label htmlFor="c-sun-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    11:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="courier-time" id="c-sun-2" />
                                                                                <label htmlFor="c-sun-2" className="btn btn-outline-secondary w-100 rounded-pill">13:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <button type="button" className="btn btn-icon btn-sm btn-outline-secodary me-n2" id="courierTimeNext" aria-label="Next">
                                                ...
                                                <div className="border-bottom">
                                                    <div className="form-check mb-0" role="listitem" data-bs-toggle="collapse" data-bs-target="#pickup" aria-expanded="false" aria-controls="pickup">
                                                        <label className="form-check-label d-flex align-items-center text-dark-emphasis fw-semibold py-4">
                                                            <input type="radio" className="form-check-input fs-base me-2 me-sm-3" name="payment-method" />
                                                            Pickup from store
                                                            <span className="fw-normal ms-auto">Free</span>
                                                        </label>
                                                    </div>
                                                    <div className="collapse" id="pickup" data-bs-parent="#shippingMethod">
                                                        <div className="pb-4 ps-3 ms-2 ms-sm-3">
                            ...
                            },
                            {
                              ...
                              &quot;customProperties&quot;: {
                                ...
                                &quot;selected&quot;: &quot;<span class=\&quot;text-dark-emphasis fw-medium\&quot;>Cartzilla Great Mall</span>&quot;
                                                            ...
                                                            <div className="d-flex justify-content-start">
                                                                <button type="button" className="btn btn-icon btn-sm btn-outline-secodary ms-n2" id="pickupTimePrev" aria-label="Prev">
                                                                    <i className="ci-chevron-left fs-lg" />
                                                                </button>
                                                                <div className="swiper swiper-load pt-2" data-swiper="{
                          &quot;slidesPerView&quot;: 2,
                              ...
                              &quot;spaceBetween&quot;: 24
                                                                    ...
                                                                    <div className="swiper-wrapper">
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Monday, 13</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-mon-1" defaultChecked />
                                                                                <label htmlFor="p-mon-1" className="btn btn-outline-secondary w-100 rounded-pill">12:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-mon-2" />
                                                                                <label htmlFor="p-mon-2" className="btn btn-outline-secondary w-100 rounded-pill">17:00 -
                                                                                    20:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Tuesday, 14</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-tue-1" />
                                                                                <label htmlFor="p-tue-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    12:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-tue-2" />
                                                                                <label htmlFor="p-tue-2" className="btn btn-outline-secondary w-100 rounded-pill">14:00 -
                                                                                    19:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Wednesday, 15</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-wed-1" />
                                                                                <label htmlFor="p-wed-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    12:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-wed-2" />
                                                                                <label htmlFor="p-wed-2" className="btn btn-outline-secondary w-100 rounded-pill">14:00 -
                                                                                    19:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Thursday, 16</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-thu-1" />
                                                                                <label htmlFor="p-thu-1" className="btn btn-outline-secondary w-100 rounded-pill">12:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-thu-2" />
                                                                                <label htmlFor="p-thu-2" className="btn btn-outline-secondary w-100 rounded-pill">17:00 -
                                                                                    20:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Friday, 17</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-fri-1" />
                                                                                <label htmlFor="p-fri-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    12:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-fri-2" />
                                                                                <label htmlFor="p-fri-2" className="btn btn-outline-secondary w-100 rounded-pill">14:00 -
                                                                                    19:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Saturday, 18</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-sat-1" />
                                                                                <label htmlFor="p-sat-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    11:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-sat-2" />
                                                                                <label htmlFor="p-sat-2" className="btn btn-outline-secondary w-100 rounded-pill">13:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="swiper-slide text-center">
                                                                            <div className="h6 fs-sm pb-2 mb-0">Sunday, 19</div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-sun-1" />
                                                                                <label htmlFor="p-sun-1" className="btn btn-outline-secondary w-100 rounded-pill">09:00 -
                                                                                    11:00</label>
                                                                            </div>
                                                                            <div className="py-1 my-1">
                                                                                <input type="radio" className="btn-check" name="pickup-time" id="p-sun-2" />
                                                                                <label htmlFor="p-sun-2" className="btn btn-outline-secondary w-100 rounded-pill">13:00 -
                                                                                    15:00</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <button type="button" className="btn btn-icon btn-sm btn-outline-secodary me-n2" id="pickupTimeNext" aria-label="Next">
                                                                    <i className="ci-chevron-right fs-lg" />
                                                                </button>
                                                            </div>
                                                        </div>
