...
//   //       const response = await UsersAxiosService.checkFollowing(businessId);
//   //       setFollowingStatus(response.data.following);
//   //       setFollowersCount(response.data.followers_count);
//   //     } else {
//   //       const response = await PagesAxiosService.checkPageFollowing(businessId);
//   //       setFollowingStatus(response.data.following);
//   //       setFollowersCount(response.data.followers_count);
//   //     }
//   //   };
...
//   //       response = await UsersAxiosService.checkFollowing(business.id);
//   //     } else {
//   //       response = await PagesAxiosService.checkPageFollowing(business.id);
//   //     }
//   //     setFollowingStatus(response.data.following);
//   //     setFollowersCount(response.data.followers_count);
//   //   } catch (err) {
...
//     // Fetch follow status when business data is available
//   // useEffect(() => {
//   //   if (business) {
//   //     fetchFollowStatus();
//   //   }
//   // }, [business, fetchFollowStatus]);

//   // useEffect(() => {
//   //   if (business) {
//   //     setFollowingStatus(business.is_following);
//   //     setFollowersCount(business.followers_count);
//   //   }
//   // }, [business]);

//     // FollowButton update handler
...
//               businessName={business.name || business.username}
//               initialFollowing={business.is_following}
//               initialFollowersCount={business.followers_count}
...
//                 initialFollowing={business.isFollowing}
...
//                 {/* <div className="container - overflow-x-auto" data-simplebar data-simplebar-auto-hide="false"> */}
...
//       const statsResponse = await PagesAxiosService.getStats(identifier);
//       setStats({
//         products_count: statsResponse.data.products_count,
//         rating: statsResponse.data.rating
//       });
//     } catch (err) {
//       console.error("Business stats error:", err);
//       setError("Failed to load business statistics");
...
//     return (
//       <div className="container py-5 text-center">
//         <h3>{error || "Business information unavailable"}</h3>
//         <button 
...
//         <div className="position-absolute top-0 start-0 p-3 d-flex align-items-center">
//           <button 
//             className="btn btn-light text-warning btn-sm me-2 badge rounded-pill"
//             onClick={() => navigate(-1)}
//             aria-label="Go back"
//           >
...
//       {/* Navigation Tabs */}
//       <nav className="profile-nav bg-light border-top border-bottom py-2 mt-2 overflow-x-auto">
//         <div className="container">
//           <ul className="nav nav-pills flex-nowrap gap-2" role="tablist">
//             <li className="nav-item" role="presentation">
//               <button
...
//                     <>
//                       <div 
//                         className="vstack gap-3 gap-md-4 mt-n3 pe-3" 
