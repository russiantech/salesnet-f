...
const Offers = () => {
    ...
    return (_jsxs("section", { className: "container pt-5 mt-2 mt-sm-3 mt-lg-4", children: [_jsxs("div", { className: "d-flex align-items-start align-items-md-center justify-content-between border-bottom pb-3 pb-md-4", children: [_jsxs("div", { className: "d-md-flex align-items-center", children: [_jsx("h2", { className: "h3 pe-3 me-3 mb-md-0", children: "Special offers for you" }), _jsxs("div", { className: "d-flex align-items-center", children: [_jsxs("div", { className: "btn btn-success pe-none px-2 rounded-pill", children: [_jsx("span", { children: timeLeft.days.toString().padStart(2, '0') }), _jsx("span", { children: "d" })] }), _jsx("div", { className: "animate-blinking text-body-tertiary fs-lg fw-medium mx-2", children: ":" }), _jsxs("div", { className: "btn btn-outline-warning pe-none px-2 rounded-pill", children: [_jsx("span", { children: timeLeft.hours.toString().padStart(2, '0') }), _jsx("span", { children: "h" })] }), _jsx("div", { className: "animate-blinking text-body-tertiary fs-lg fw-medium mx-2", children: ":" }), _jsxs("div", { className: "btn btn-outline-danger pe-none px-2 rounded-pill", children: [_jsx("span", { children: timeLeft.minutes.toString().padStart(2, '0') }), _jsx("span", { children: "m" })] }), _jsx("div", { className: "animate-blinking text-body-tertiary fs-lg fw-medium mx-2", children: ":" }), _jsxs("div", { className: "btn btn-outline-info pe-none px-2 rounded-pill", children: [_jsx("span", { children: timeLeft.seconds.toString().padStart(2, '0') }), _jsx("span", { children: "s" })] })] })] }), _jsx("div", { className: "nav ms-3", children: _jsxs(Link, { to: "/offers", className: "nav-link badge text-bg-success rounded-pill animate-scale", children: [_jsx("span", { className: "text-nowrap animate-target", children: "View all " }), _jsx("i", { className: "ci-chevron-right fs-base ms-1 animate-target" })] }) })] }), _jsxs("div", { className: "position-relative mx-md-1", children: [_jsx("button", { ref: prevRef, type: "button", className: "offers-prev btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-start position-absolute top-50 start-0 z-2 translate-middle-y ms-n1 d-none d-sm-inline-flex", "aria-label": "Previous slide", children: _jsx("i", { className: "ci-chevron-left fs-lg animate-target" }) }), _jsx("button", { ref: nextRef, type: "button", className: "offers-next btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-end position-absolute top-50 end-0 z-2 translate-middle-y me-n1 d-none d-sm-inline-flex", "aria-label": "Next slide", children: _jsx("i", { className: "ci-chevron-right fs-lg animate-target" }) }), _jsx(Swiper, { modules: [Navigation, Autoplay], spaceBetween: 24, slidesPerView: 2, loop: true, autoplay: {
                        ...
                        }, className: "py-4 px-sm-3", children: products.map((product) => (_jsx(SwiperSlide, { children: _jsx("div", { className: "product-card animate-underline hover-effect-opacity bg-body rounded h-100", children: _jsxs("div", { className: "position-relative h-100 d-flex flex-column", children: [_jsxs("div", { className: "position-relative flex-grow-1", children: [_jsx("div", { className: "position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 mt-3 me-3", children: _jsxs("div", { className: "d-flex flex-column gap-2", children: [_jsx("button", { type: "button", className: "btn btn-icon btn-secondary animate-pulse d-none d-lg-inline-flex", "aria-label": `Add ${product.name} to Wishlist`, children: _jsx("i", { className: "ci-heart fs-base animate-target" }) }), _jsx("button", { type: "button", className: "btn btn-icon btn-secondary animate-rotate d-none d-lg-inline-flex", "aria-label": `Compare ${product.name}`, children: _jsx("i", { className: "ci-refresh-cw fs-base animate-target" }) })] }) }), _jsxs("div", { className: "dropdown d-lg-none position-absolute top-0 end-0 z-2 mt-2 me-2", children: [_jsx("button", { type: "button", className: "btn btn-icon btn-sm btn-secondary bg-body", "data-bs-toggle": "dropdown", "aria-expanded": "false", "aria-label": `More actions for ${product.name}`, children: _jsx("i", { className: "ci-more-vertical fs-lg" }) }), _jsxs("ul", { className: "dropdown-menu dropdown-menu-end fs-xs p-2", style: { minWidth: "auto" }, children: [_jsx("li", { children: _jsxs("button", { className: "dropdown-item", children: [_jsx("i", { className: "ci-heart fs-sm ms-n1 me-2" }), "Add to Wishlist"] }) }), _jsx("li", { children: _jsxs("button", { className: "dropdown-item", children: [_jsx("i", { className: "ci-refresh-cw fs-sm ms-n1 me-2" }), "Compare"] }) })] })] }), _jsx(Link, { to: product.link, className: "d-block rounded-top overflow-hidden p-3 p-sm-4", "aria-label": `View details for ${product.name}`, children: _jsx("div", { className: "ratio", style: { "--cz-aspect-ratio": "calc(240 / 258 * 100%)" }, children: _jsx("img", { src: product.image, alt: product.name, className: "img-fluid", loading: "lazy" }) }) })] }), _jsxs("div", { className: "w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3", children: [_jsxs("div", { className: "d-flex align-items-center gap-2 mb-2", children: [_jsx("div", { className: "d-flex gap-1 fs-xs", children: renderStars(product.rating) }), _jsxs("span", { className: "text-body-tertiary fs-xs", children: ["(", product.reviews, ")"] })] }), _jsx("h3", { className: "pb-1 mb-2", children: _jsx(Link, { to: product.link, className: "d-block fs-sm fw-medium text-truncate", children: _jsx("span", { className: "animate-target", children: product.name }) }) }), _jsxs("div", { className: "d-flex align-items-center justify-content-between pb-2 mb-1", children: [_jsxs("div", { className: "h5 lh-1 mb-0", children: ["$", product.price.toFixed(2), _jsxs("del", { className: "text-body-tertiary fs-sm fw-normal", children: ["$", product.originalPrice.toFixed(2)] })] }), _jsx("button", { type: "button", className: "product-card-button btn btn-icon btn-secondary animate-slide-end ms-2", "aria-label": `Add ${product.name} to Cart`, children: _jsx("i", { className: "ci-shopping-cart fs-base animate-target" }) })] }), _jsx("div", { className: "progress mb-2", role: "progressbar", "aria-label": `Available stock for ${product.name}`, "aria-valuenow": product.stockPercentage, "aria-valuemin": "0", "aria-valuemax": "100", style: { height: "4px" }, children: _jsx("div", { className: "progress-bar rounded-pill", style: { width: `${product.stockPercentage}%` } }) }), _jsxs("div", { className: "text-body-secondary fs-sm", children: ["Available: ", _jsx("span", { className: "text-dark-emphasis fw-medium", children: product.stock })] })] })] }) }) }, product.id))) }), _jsxs("div", { className: "d-flex justify-content-center gap-2 mt-n2 mb-3 pb-1 d-sm-none", children: [_jsx("button", { ref: mobilePrevRef, type: "button", className: "offers-prev btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-start me-1", "aria-label": "Previous slide", children: _jsx("i", { className: "ci-chevron-left fs-lg animate-target" }) }), _jsx("button", { ref: mobileNextRef, type: "button", className: "offers-next btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-end", "aria-label": "Next slide", children: _jsx("i", { className: "ci-chevron-right fs-lg animate-target" }) })] })] })] }));
};
export default Offers;
