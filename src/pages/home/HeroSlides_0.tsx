        ...
        <section className="container pt-4">
            ...
            <div className="col-lg-9 offset-lg-3">
                ...
                <div className="row justify-content-center position-relative z-2">
                    ...
                    <div className="swiper user-select-none swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" id="sliderImages" data-swiper="{
