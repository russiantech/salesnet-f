...
const Bonuses = () => {
  ...
  {/* Bonuses info modal */}
  <div className="modal fade" id="bonusesModal" tabIndex={-1} aria-labelledby="bonusesModalLabel" aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered">
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title" id="bonusesModalLabel">My Balances</h5>
            ...
            <div className="col-sm-6">
              <ul className="list-unstyled fs-sm m-0">
                <li className="d-flex align-items-center justify-content-between">
                  Available:
                  <span className="text-dark-emphasis fw-semibold ms-2">{formatCurrency(1.00, 'NGN', {short: false})}</span>
                </li>
                <li className="d-flex align-items-center justify-content-between">
                  Earnings:
                  <span className="text-dark-emphasis fw-semibold ms-2">{formatCurrency(0.0, 'NGN', {short: false})}</span>
                </li>
                <li className="d-flex align-items-center justify-content-between">
                  Deposit:
                  <span className="text-dark-emphasis fw-semibold ms-2">{formatCurrency(0.0, 'NGN', {short: false})}</span>
