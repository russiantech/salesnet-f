        ...
        <div className="container pt-4 pt-lg-5 pb-5">
          <div className="row pt-sm-2 pt-md-3 pt-lg-0 pb-2 pb-sm-3 pb-md-4 pb-lg-5">
            ...
            <div className="nav overflow-x-auto mb-2">
              <ul className="nav nav-pills flex-nowrap gap-2 pb-2 mb-1" role="tablist">
                <li className="nav-item me-1" role="presentation">
                  <button type="button" className="nav-link text-nowrap active" id="published-tab" data-bs-toggle="pill" data-bs-target="#published" role="tab" aria-controls="published" aria-selected="true">
                    Published (3)
                  </button>
                </li>
                <li className="nav-item me-1" role="presentation">
                  <button type="button" className="nav-link text-nowrap" id="drafts-tab" data-bs-toggle="pill" data-bs-target="#drafts" role="tab" aria-controls="drafts" aria-selected="false" tabindex="-1">
                    Drafts (2)
                  </button>
                </li>
                <li className="nav-item" role="presentation">
                  <button type="button" className="nav-link text-nowrap" id="archived-tab" data-bs-toggle="pill" data-bs-target="#archived" role="tab" aria-controls="archived" aria-selected="false" tabindex="-1">
                    Archived (0)
                  </button>
                </li>
              </ul>
            ...
            <div className="tab-content">
              ...
              {/* <!-- Published tab --> */}
              <div className="tab-pane fade active show" id="published" role="tabpanel" aria-labelledby="published-tab">

                {/* <!-- Master checkbox + Action buttons --> */}
                <div className="nav align-items-center mb-4">
                  <div className="nav-link fs-lg ps-0 pe-2 py-2 mt-n1 me-4" data-master-checkbox="{&quot;container&quot;: &quot;#publishedSelection&quot;, &quot;label&quot;: &quot;Select all the ads to apply the same action to them&quot;, &quot;labelChecked&quot;: &quot;Unselect all&quot;, &quot;showOnCheck&quot;: &quot;#published-action-buttons&quot;}">
                    <input type="checkbox" className="form-check-input" id="published-master" checked="" />
                    <label for="published-master" className="form-check-label fw-normal mt-1 ms-2">Unselect all</label>
                  </div>
                  <div className="d-flex flex-wrap" id="published-action-buttons">
                    <a className="nav-link position-relative px-0 pe-sm-2 py-2 me-4" href="#!">
                      <i className="fi-zap fs-base me-2"></i>
                      <span className="hover-effect-underline stretched-link d-none d-md-inline">Promote</span>
                    </a>
                    <a className="nav-link position-relative px-0 pe-sm-2 py-2 me-4" href="#!">
                      <i className="fi-archive fs-base me-2"></i>
                      <span className="hover-effect-underline stretched-link d-none d-md-inline">Move to archive</span>
                    </a>
                    <a className="nav-link position-relative text-danger px-0 py-2" href="#!">
                      <i className="fi-trash fs-base me-1"></i>
                      <span className="hover-effect-underline stretched-link d-none d-md-inline">Delete</span>
                    </a>
                  </div>
                </div>
