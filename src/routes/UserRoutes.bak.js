...
const UserRoutes = () => (_jsxs(_Fragment, { children: [_jsx(Navigation, {}), _jsx(Suspense, { fallback: _jsx("div", { children: "Loading..." }), children: _jsxs(Routes, { children: [_jsx(Route, { path: "/personal", element: _jsxs(PrivateRoute, { children: ["  ", _jsx(Personal, {}), " "] }) }), _jsx(Route, { path: "/notifications", element: _jsx(Notifications, {}) }), _jsx(Route, { path: "/addresses", element: _jsx(Addresses, {}) }), _jsx(Route, { path: "/favorites", element: _jsx(Favorites, {}) }), _jsx(Route, { path: "/orders", element: _jsx(Orders, {}) }), _jsx(Route, { path: "/payments", element: _jsx(Payments, {}) }), _jsx(Route, { path: "/reviews", element: _jsx(Reviews, {}) }), _jsx(Route, { path: "/basket", element: _jsx(Basket, {}) }), _jsx(Route, { path: "/checkout", element: _jsx(Checkout, {}) }), _jsx(Route, { path: "/terms", element: _jsx(Terms, {}) }), _jsx(Route, { path: "/help", element: _jsx(Help, {}) }), _jsx(Route, { path: "/help/:slug", element: _jsx(HelpSingle, {}) })] }) })] }));
export default UserRoutes;
